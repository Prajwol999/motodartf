...
import '../../domain/entity/service_entity.dart';
import '../../../booking/presentation/view/create_booking.dart';
  ...
  void _onServiceTap(BuildContext context, ServiceEntity service) {
    showDialog(
      ...
      builder: (dialogContext) => AlertDialog(
        ...
        title: Row(
          children: [
            const Icon(Icons.build_circle_outlined, color: AppColors.brandPrimary, size: 24),
        ...
        content: Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text('Description: ${service.description}', style: const TextStyle(color: AppColors.textSecondary)),
            const SizedBox(height: 8),
            Text('Duration: ${service.duration ?? "N/A"}', style: const TextStyle(color: AppColors.textSecondary)),
            const SizedBox(height: 8),
            Text('Price: Rs. ${service.price.toStringAsFixed(0)}', style: const TextStyle(color: AppColors.statusSuccess)),
          ],
        ),
        actions: [
          TextButton(
